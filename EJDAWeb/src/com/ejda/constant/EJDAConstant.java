...
public class EJDAConstant {
	...
	public interface SQL{
		...
		public final String FORM_T_DOC_2 = "SELECT DOC_ID, COUNTRY_ID, JDA_TYPE, DOC_STATUS, INVOICE_NO, CONSIGNOR_CODE, CONSIGNOR_NAME, "
										...
										+ "RECEIVED_AMOUNT, EXCHGRATE_ID, EQUIVALENT, GOOD_PAYMENT, COUNTRY_OF_GOOD, FOB_VALUE, INSURANCE, FREIGHT, CIF_VALUE, "
										+ "GROSS_WEIGHT, MEASUREMENT, OTHER_CHARG, DECLARANT_NAME, ID_CARD_NO, STATUS, CERIFY, CUS_REMOVAL, TAX_TOTAL, "
										+ "OTHER_CHARG2, PAYABLE_AMOUNT, MANUALSCRIPT_RECERPT, CREATE_DATE, CREATE_BY, UPDATE_DATE, UPDATE_BY "
										+ "FROM JDA_FORM_T_DOC WHERE DOC_STATUS = 'A' AND JDA_TYPE = '1'";
	}
}

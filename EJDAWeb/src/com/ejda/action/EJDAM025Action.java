...
public class EJDAM025Action extends AbstractAction {

	private Logger log = Logger.getLogger(EJDAM025Action.class);
...
//			dao.UpdateFrom4Table(form4);
			...
			transactionLogModel.setMenuId("M025");
			transactionLogModel.setTranAction("ADD");
			transactionLogModel.setDescription("Update EJDA Table 4 Form 4");
...
//		log.debug("ejdaMethod = "+getRequest().getParameter("ejdaMethod"));
		...
		try{
			...
			form4Bean.setActionName("EJDAM025");

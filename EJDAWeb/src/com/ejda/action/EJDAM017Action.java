...
public class EJDAM017Action extends AbstractAction {

	private Logger log = Logger.getLogger(EJDAM017Action.class);
...
//		form4.setForm_no(formNo);
		try{
			...
			Form1Model form1 = ejdam010Action.setValueModel("4","S",iuser);
...
//			dao.UpdateFrom4Table(form4);
			...
			transactionLogModel.setMenuId("M017");
			transactionLogModel.setTranAction("ADD");
			transactionLogModel.setDescription("Update EJDA Table 2 Form 4");
...
//		log.debug("ejdaMethod = "+getRequest().getParameter("ejdaMethod"));
		...
		try{
			...
			form4Bean.setActionName("EJDAM017");

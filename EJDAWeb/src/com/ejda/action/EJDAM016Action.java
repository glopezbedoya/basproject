...
public class EJDAM016Action extends AbstractAction {

	private Logger log = Logger.getLogger(EJDAM016Action.class);
...
//			dao.UpdateFrom3Table(form3);
			...
			transactionLogModel.setMenuId("M016");
			transactionLogModel.setTranAction("ADD");
			transactionLogModel.setDescription("Update EJDA Table 2 Form 3");
...
//		log.debug("ejdaMethod = "+getRequest().getParameter("ejdaMethod"));
		...
		try{
			...
			form3Bean.setActionName("EJDAM016");
	...
	private String setSQL(Form1Model form3Cri){
		...
		try{
			...
			sql.append("  WHERE JDA_TYPE = '3' AND DOC_STATUS = 'A' ");

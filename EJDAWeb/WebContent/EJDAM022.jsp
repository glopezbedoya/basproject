...
<form name="ejdaformNo1" method="post" action="/EJDAWeb/EJDAControler">
	...
	<table align="center" width="800" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr align="left">
          <td align="left" class="style1" scope="row"><font class="textTop">TABLE 4 >> FORM No. 1</font></td>
          <td>&nbsp;</td>
        ...
        <tr>
       		...
       		<td align="left"><%=DisplayFormatUtil.displayInputTextBox("txtFormName",form1ModelSP.getForm_name(),"") %><%=DisplayFormatUtil.displayButton("Search","onclick=\"buttonAction(this.form,'EJDAM022','doSearch','EJDAM022.jsp')\"",false) %></td>

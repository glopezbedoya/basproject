...
<%@page import="com.tcd.ejda.model.Form1Model"%><script language="javascript" src="js/EJDAM013.js"></script>
<%
...
<form name="ejdaformNo1" method="post" action="/EJDAWeb/EJDAControler">
	...
	<table align="center" width="800" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr align="left">
          <td align="left" class="style1" scope="row"><font class="textTop">TABLE 3 >> FORM No. 4</font></td>
          <td>&nbsp;</td>
        ...
        <tr>
       		...
       		<td align="left"><%=DisplayFormatUtil.displayInputTextBox("txtFormName",form4ModelSP.getForm_name(),"") %><%=DisplayFormatUtil.displayButton("Search","onclick=\"buttonAction(this.form,'EJDAM021','doSearch','EJDAM021.jsp')\"",false) %></td>

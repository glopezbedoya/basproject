<%@page import="com.tcd.ejda.model.Form4Model"%>
...
<script language="javascript" src="js/ejdaform4.js"></script>
...
<%
	...
	Form4Model form1M = new Form4Model();
    ...
    <td align="center"><table width="800" border="0" cellspacing="1" cellpadding="1" bgcolor="#F8F8F8">
      ...
      <tr>
        ...
        <td rowspan="3" align="center"><table width="472" border="0" cellpadding="1" cellspacing="1">
          ...
          <tr>
            <td align="left" ><input type="text" name="specialTreament" id="specialTreament" /></td>
            <td align="left" ><input type="text" name="exportPemit" id="exportPemit" /></td>
            <td align="left" ><input type="text" name="exchangeControl" id="exchangeControl" /></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
          	<td colspan="3"><table width="472" border="0" cellpadding="1" cellspacing="1">
	          	...
	          	<tr>
		            <td align="left" ><input type="text" name="countryOfOrigin" id="countryOfOrigin" /></td>
		            <td align="left" ><input type="text" name="countryOfOriginCode" id="countryOfOriginCode" size="4" /></td>
		            <td align="left" ><input type="text" name="countryFinalDestination" id="countryFinalDestination" /></td>
		            <td align="left" ><input type="text" name="countryOfOriginCode" id="countryOfOriginCode" size="4" /></td>
	            </tr>
          	</table></td>
          	</tr>
            ...
            <tr>
          	<td colspan="3"><table width="472" border="0" cellpadding="1" cellspacing="1">
	          	...
	          	<tr>
		            <td align="left" ><input type="text" name="termDelivery" id="termDelivery" /></td>
		            <td align="left" ><input type="text" name="currency" id="currency" size="4" /></td>
		            <td align="left" ><input type="text" name="currencyCode" id="currencyCode"size="4" /></td>
		            <td align="left" ><input type="text" name="amtReceived" id="amtReceived"  /></td>
	            </tr>
          	</table></td>
          	</tr>
          	 <tr>
          ...
          <tr>
            ...
            <td align="left" ><input type="text" name="equivalent" id="equivalent" /></td>
          ...
          <tr>
            <td align="left" colspan="2"><input type="text" name="exchangeRate" id="exchangeRate" />
            					<input type="text" name="paymentForGoods" id="paymentForGoods" size="3"/></td>
            <td align="left" ><input type="text" name="fregil" id="fregil" /></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td align="left" ><input type="text" name="gross" id="gross" /></td>

...
<form name="ejdaformNo2" method="post" action="/EJDAWeb/EJDAControler">
	...
	<table align="center" width="800" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr align="left">
          <td align="left" class="style1" scope="row"><font class="textTop">TABLE 2 >> FORM No. 2</font></td>
          <td>&nbsp;</td>
        ...
        <tr>
          <th colspan="4" scope="row" align="center"><table width="951" border="0" align="center" cellpadding="0" cellspacing="1">
            ...
            %>
			            ...
			            <tr onclick="updateEJDATable2(this.form,'<%=form2M.getDoc_ID() %>','EJDAM015');" style="cursor:hand">

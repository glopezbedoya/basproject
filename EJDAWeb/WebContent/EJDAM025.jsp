...
<form name="ejdaformNo1" method="post" action="/EJDAWeb/EJDAControler">
	...
	<table align="center" width="800" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
       		...
       		<td align="left"><%=DisplayFormatUtil.displayInputTextBox("txtFormName",form4ModelSP.getForm_name(),"") %><%=DisplayFormatUtil.displayButton("Search","onclick=\"buttonAction(this.form,'EJDAM025','doSearch','EJDAM013.jsp')\"",false) %></td>

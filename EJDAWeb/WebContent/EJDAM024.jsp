...
<form name="ejdaformNo1" method="post" action="/EJDAWeb/EJDAControler">
	...
	<table align="center" width="800" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
       		...
       		<td align="left"><%=DisplayFormatUtil.displayInputTextBox("txtFormName",form3ModelSP.getForm_name(),"") %><%=DisplayFormatUtil.displayButton("Search","onclick=\"buttonAction(this.form,'EJDAM024','doSearch','EJDAM024.jsp')\"",false) %></td>

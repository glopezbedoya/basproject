...
<form name="ejdaformNo2" method="post" action="/EJDAWeb/EJDAControler">
	...
	<table align="center" width="800" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr align="left">
          <td align="left" class="style1" scope="row"><font class="textTop">TABLE 1 >> FORM No. 2</font></td>
          <td>&nbsp;</td>
        ...
        <tr>
       		...
       		<td width="100"></td>
       		<td width="700"class="text" align="right"><%=DisplayFormatUtil.displayButton("AddForm2","onclick=\"buttonAction(this.form,'EJDAM011','doAdd','eJdaForm2.jsp')\"",false) %> </td>
        ...
        <tr>
       		...
       		<td align="left"><%=DisplayFormatUtil.displayInputTextBox("txtFormName",form2ModelSP.getForm_name(),"") %><%=DisplayFormatUtil.displayButton("Search","onclick=\"buttonAction(this.form,'EJDAM011','doSearch','EJDAM011.jsp')\"",false) %></td>
        ...
        <tr>
          <th colspan="4" scope="row" align="center"><table width="951" border="0" align="center" cellpadding="0" cellspacing="1">
            ...
            %>
			            ...
			            <tr onclick="updateEJDATable2(this.form,'<%=form2M.getForm_no() %>');" style="cursor:hand">

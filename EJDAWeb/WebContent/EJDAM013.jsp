...
<form name="ejdaformNo1" method="post" action="/EJDAWeb/EJDAControler">
	...
	<table align="center" width="800" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr align="left">
          <td align="left" class="style1" scope="row"><font class="textTop">TABLE 1 >> FORM No. 4</font></td>
          <td>&nbsp;</td>
        ...
        <tr>
       		...
       		<td width="100"></td>
       		<td width="700"class="text" align="right"><%=DisplayFormatUtil.displayButton("AddForm4","onclick=\"buttonAction(this.form,'EJDAM013','doAdd','ejdaForm4.jsp')\"",false) %> </td>
        ...
        <tr>
       		...
       		<td align="left"><%=DisplayFormatUtil.displayInputTextBox("txtFormName",form4ModelSP.getForm_name(),"") %><%=DisplayFormatUtil.displayButton("Search","onclick=\"buttonAction(this.form,'EJDAM013','doSearch','EJDAM013.jsp')\"",false) %></td>
		...
		<!--Panging-->
         ...
         log.debug("valueListM >> " + valueListM.getItemsPerPage());
			...
			%>
			 <%
            	if(form4Vt != null && form4Vt.size() > 0){%>
        <tr>
          ...
          <th colspan="4" scope="row" align="center"><table width="951" border="0" align="center" cellpadding="0" cellspacing="1">
            ...
            %>
			            ...
			            <tr onclick="updateEJDATable2(this.form,'<%=form4M.getForm_no() %>');" style="cursor:hand">
			              ...
			              <td <%=bgColor %> class="text"><%=form4M.getForm_status()%></td>

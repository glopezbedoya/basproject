...
<form name="ejdaformNo1" method="post" action="/EJDAWeb/EJDAControler">
	...
	<table align="center" width="800" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr align="left">
          <td align="left" class="style1" scope="row"><font class="textTop">TABLE 1 >> FORM No. 3</font></td>
          <td>&nbsp;</td>
        ...
        <tr>
       		...
       		<td width="100"></td>
       		<td width="700"class="text" align="right"><%=DisplayFormatUtil.displayButton("AddForm3","onclick=\"buttonAction(this.form,'EJDAM012','doAdd','ejdaForm3.jsp')\"",false) %> </td>
        ...
        <tr>
       		...
       		<td align="left"><%=DisplayFormatUtil.displayInputTextBox("txtFormName",form3ModelSP.getForm_name(),"") %><%=DisplayFormatUtil.displayButton("Search","onclick=\"buttonAction(this.form,'EJDAM012','doSearch','EJDAM012.jsp')\"",false) %></td>
